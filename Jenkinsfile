pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/allenjj2'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/justinjoallen/225-lab3-7'                                    //<------your MiamiID
        KUBECONFIG = credentials('allenjj2-225-sp26')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.228.115 \
